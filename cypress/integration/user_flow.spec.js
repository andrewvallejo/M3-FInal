  ...
  it('Should successfully see the homepage upon visit', () => {
    ...
    cy.get('input')
      ...
      cy.get('section > :nth-child(1)')
        .should('include.text', 'Patbeanslettucecarnitasqueso frescojalapeno')
      cy.get('section > :nth-child(2)')
        .should('include.text', 'Samsteakpico de gallolettucecarnitasqueso frescojalapen')
      cy.get('section > :nth-child(3)')
        .should('include.text', 'Alexsofritasbeanssour creamcarnitasqueso fresco')
